...
class BlockExtractor:
    ...
    def find_blocks(
        ...
        while i < len(lines):
            ...
            # 2. Check for a START delimiter of ANY block type
            # current_absolute_depth is the depth this new block would be at if it's a start delimiter
            ...
            for btype_candidate, delims_candidate in self.block_types.items():
                ...
                if stripped_line_text.startswith(start_delim_str):
                    ...
                    if (
                        ...
                        and btype_candidate == block_type
                    ):
                        current_target_block_content = (
                            []
                        ...
                        current_target_block_content.append(line_text)
                    break  # Found a starting delimiter, no need to check other types for this line
